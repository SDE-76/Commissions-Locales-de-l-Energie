...
map.getView().fit([3684.918915, 6314118.276090, 201482.915414, 6460175.576144], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Commissions Locales de l\'Energie</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (218 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'Découpage géographique du territoire de la Seine-Maritime par le SDE76.<br /><br />En cliquant sur le nom d\'une commune, vous aurez accès au nom du technicien travaux responsable de cette CLE ainsi que du responsable maintenance';
            }
